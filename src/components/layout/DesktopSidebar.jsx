...
import { Heart, Calendar, Users, MapPin, FileText, CreditCard, User, Home, Settings } from 'lucide-react';
    ...
    <aside className="hidden md:flex fixed left-0 top-0 h-full w-64 flex-col bg-white border-r border-gray-100" style={{ zIndex: 30 }}>
      ...
      <div className="p-4 border-t border-gray-100 space-y-2">
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${isActive(settingsNavItem.to) ? 'bg-red-50 text-cvs-red font-semibold' : 'text-gray-600 hover:bg-gray-50'}`}
