    ...
    <div className="pb-6">
      ...
      <div className="bg-green-50 border border-green-200 rounded-2xl p-5 mb-6 flex items-center gap-4">
        <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center">
          <Check className="w-6 h-6 text-cvs-green" />
        </div>
        <div>
          <h3 className="font-bold text-cvs-green">Treatment Completed</h3>
          <p className="text-sm text-cvs-green">{format(new Date(), 'MMMM d, yyyy • h:mm a')}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-5 mb-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-bold text-gray-900">Treatment Summary</h3>
          {!editing && (
            <Button 
              variant="ghost" 
              size="sm"
              onClick={startEditing}
              className="text-cvs-blue"
            >
              <Edit size={16} />
              Edit
            </Button>
        ...
        {treatment.treatment_types?.length > 0 && (
          <div className="mb-4">
            <p className="text-sm text-gray-500 mb-2">Treatments Applied</p>
            <div className="flex flex-wrap gap-2">
              {treatment.treatment_types.map((type) => (
                <Badge 
                  key={type}
                  variant="secondary"
                  className="bg-blue-100 text-cvs-blue hover:bg-blue-100"
                >
                  {type}
                </Badge>
              ))}
