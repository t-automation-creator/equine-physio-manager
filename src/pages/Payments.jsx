  ...
  return (
    <div className="pb-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5">
          <div className="flex items-center gap-2 text-cvs-red mb-2">
            <AlertTriangle size={18} />
            <span className="text-sm font-medium">Overdue</span>
          </div>
          <p className="text-2xl font-bold text-cvs-red">
      ...
      <h2 className="font-bold text-gray-900 mb-4">Outstanding Invoices</h2>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        {isOverdue && (
                          <span className="text-xs bg-red-50 text-cvs-red px-2.5 py-1 rounded-full font-semibold">
